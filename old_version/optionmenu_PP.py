...
ROI_NAMES = [    
    #['ITV_1980', 'ITV1980', 'ICTV19.8', 'ITV_19.8'],
    ['ITV_3000', 'ITVn_3000', 'ITV3000', 'ICTV30', 'ITV_30'],
    # ['CTV_2980 new'],
    ['External'],
    ['BODY'],
    ['A_Carotid_L'],['A_Carotid_R'],
    ['Atrium_L'],['Atrium_R'],
    ['Esophagus'],
    ['Breast_L'],['Breast_R'],
    ['Heart'],
    ...
    ['Sternum'],
    [r'Rib/Clavicula'],
    ['Rib_1_L'],['Rib_2_L'],['Rib_3_L'],['Rib_4_L'],
    ['Rib_1_R'],['Rib_2_R'],['Rib_3_R'],['Rib_4_R'],
    ['Parotid_L'],['Parotid_R'],
    ['CricoPharyngeal_Muscle', 'CricoPharyngeal_Inlet', 'cricopharyngeus', 'Crico'],
    ['PharynxConst_Inf', 'pcm_inf'],
    ['PharynxConst_Sup', 'pcm_sup'],
    ['Myelum', 'SpinalCord'],
    ['Submandibular_L', 'submandibularis_li'],
    ['Submandibular_R', 'submandibularis_re'],
    ['PharynxConst_Med', 'PCM_med'],
    ['Myelum'],
    ['Brainstem', 'BrainStem'],
    ['Thyroid'],]
...
'''Define path'''
# dashboard_storage_path = Path('\\\\zkh\\appdata\\RTFysica\\Pietro\\PowerBI\\Lymphoma\\dashboard-storage\\')
# dashboard_storage_path = Path('\\\\zkh\\appdata\\RTFysica\\Pietro\\PowerBI\\Lymphoma\\\\dashboard-storage\\')
user_name = os.getlogin()
user_name.replace(" ","_")
dashboard_storage_path = Path('\\\\zkh\\appdata\\RTFysica\\Pietro\\PowerBI\\Lymphoma\\Dashboard\\dashboard-storage\\' ) / user_name
print(dashboard_storage_path)
dashboard_storage_path.mkdir(mode=0o777, parents=True, exist_ok=True)
baseline_storage_path = Path('\\\\zkh\\appdata\\RTFysica\\Pietro\\PowerBI\\Lymphoma\\Dashboard\\baseline-storage\\')
...
exec(open(script_path / 'new_window.py').read())
