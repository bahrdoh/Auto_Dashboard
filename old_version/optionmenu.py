...
ROI_NAMES = ['CTV_7000', 'CTV_5425', 'BODY', 'BaseOfTongue', 'Brain', 'BrainStem', 'Cerebellum', 'Cerebrum',
             ...
             'Lacrimal_L', 'Lacrimal_R', 'non-NTCP-OARs_out', 'OpticNerve_L', 'OpticNerve_R', 'OralCavity_Ext', 
             'Parotid_L', 'Parotid_R', 'PCM_Inf', 'PCM_Med', 'PCM_Sup', 'Submandibular_L', 'Submandibular_R', 'SpinalCord', 'Supraglottic', 'Thyroid']
