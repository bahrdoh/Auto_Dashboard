...
def create_new_window_proton():
    ...
    # ''' Volume ROIs '''
    # oral_cavity_predictions, pcmsup_predictions = calculate_oar_prediction(plan) #Ilse
    ...
    #     add_line(plan_info + ['PCM_Sup', 'nominal', predicted_labels[i],  float_to_string(pcmsup_predictions[i]),'cGy (RBE)']) #Ilse
...
# use last line to capture the unit, or modify get clinical goal        
    ...
    # except:
    #     conformity_index_7000 = conformity_index(plan, 0.95*7000, '_PTVt_High&_External-0.5') 
    #     conformity_index_5425 = conformity_index(plan, 0.95*5425, '_PTVt_Low&_External-0.5')         
    ...
    # except:
    #     add_line(plan_info + ['_PTVt_High&_External-0.5', 'nominal', 'Conformity index PTV_7000_eval',   float_to_string(conformity_index_7000)])
    #     add_line(plan_info + ['_PTVt_Low&_External-0.5', 'nominal', 'Conformity index PTV_P425_eval',   float_to_string(conformity_index_5425)])    
    ...
    # except:
    #     homogeneity_index_7000 = homogeneity_index(plan, 0.98, '_PTVt_High&_External-0.5') 
    #     homogeneity_index_5425 = homogeneity_index(plan, 0.98, '_PTVt_Low&_External-0.5')           
    ...
    # except:
    #     add_line(plan_info + ['_PTVt_High&_External-0.5', 'nominal', 'Homogeneity index PTV_7000_eval',   float_to_string(homogeneity_index_7000)])
    #     add_line(plan_info + ['_PTVt_Low&_External-0.5', 'nominal', 'Homogeneity index PTV_5425_eval',   float_to_string(homogeneity_index_5425)]) 
